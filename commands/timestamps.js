exports.run = (client, message, args) => {
    message.channel.send(`The secret videos posted on social media have a difference to the videos send to people: they contain a timestamp at the bottom right corner.
