module.exports = async (client, oldMember, newMember) => {
    if (newMember.guild.id == "226576492782551042") {
        if (oldMember.pending && !newMember.pending) {
            ...
            // welcomeChannel.send(`Welcome ${newMember.toString()} to the Imagine Dragons server! Feel free to introduce yourself to others, you can tell them things like your favourite song, how you found ID, and/or a little about yourself. If you want roles to represent your favourite album, pronouns, or get notified for events, type "/roles" for the role selection. We hope you enjoy your stay here!`)
            welcomeChannel.send(`Welcome ${newMember.toString()} to the Ragged Insomnia server! Feel free to introduce yourself to others, you can tell them things like your favourite song, how you found RI, and/or a little about yourself. We hope you enjoy your stay here!`)
        }
    }
}